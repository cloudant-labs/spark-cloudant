...
print ('About to test com.cloudant.spark.CloudantRP for n_customer with setting schemaSampleSize to 5')
sqlContext.sql(" CREATE TEMPORARY TABLE customerTable USING com.cloudant.spark.CloudantRP OPTIONS ( schemaSampleSize '5',database 'n_customer')")
verify()
