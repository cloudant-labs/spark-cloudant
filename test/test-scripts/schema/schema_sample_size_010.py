...
print ('About to test com.cloudant.spark.CloudantPrunedFilteredRP for n_customer with setting schemaSampleSize to 5')
sqlContext.sql(" CREATE TEMPORARY TABLE customerTable USING com.cloudant.spark.CloudantPrunedFilteredRP OPTIONS ( schemaSampleSize '5',database 'n_customer')")
verify()
