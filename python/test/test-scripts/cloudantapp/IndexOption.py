...
conf = SparkConf().setAppName("n_flight basic tests with index in option - Python")
...
url = "https://<cloudanthost>/n_flight/_design/view/_search/n_flights?q=flightSegmentId:{AA9%20TO%20AA95}"
